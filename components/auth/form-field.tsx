...
export const inputClass =
  'w-full rounded border border-zinc-700/70 bg-zinc-800/60 px-3.5 py-2.5 text-sm text-zinc-50 placeholder:text-zinc-600 outline-none transition-all duration-200 focus:border-primary/60 focus:bg-zinc-800 focus:ring-2 focus:ring-inset focus:ring-primary/10 aria-invalid:border-red-500/60 aria-invalid:focus:ring-red-500/10'
